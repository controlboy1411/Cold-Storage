...
import { Header, MenuTab, DashboardCommon, Footer, AboutUs, MenuTabMobile } from '../../components';
    ...
    return (
        <ThemeProvider theme={createTheme()}>
            <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'auto' }}>
                ...
                <div>
                    <div className='dashboard-about-container' style={{display: appContext.showButtonAbousUs ? 'block' : 'none'}} onClick={() => setShowAboutUs(true)}>
